...
@NoArgsConstructor
@Builder
public class GeminiProvider extends AbstractModelProvider {

    @Builder.Default
    private ProtocolType providerType = ProtocolType.GEMINI;

    @Builder.Default
    private String baseUrl = ProviderBaseUrl.GEMINI_NATIVE.getBaseUrl();
}